...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Posto : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> Valor : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         <p> Modo de Pagamento : <span><?php echo $fetch_orders['method']; ?></span> </p>
